...
vi.mock('@/components/milkdown/useMarkdownPlaygroundShortcuts', () => ({
  useMarkdownPlaygroundShortcuts: shortcutBridgeMock,
}))
...
export const renderReadyHarness = async (onChange: (markdown: string) => void, value: string) => {
